...
let title = "Mitch Cuckovich";
let age = 25;
let birthday = "January 25";
...
if (detroitGC === true) {
    console.log(`My name is ${title} and I am a student at Grand Circus in Detroit, Michigan. I am currently ${age} years old and my birthday is on ${birthday}.`)
}else{
    console.log(`My name is ${title} and I am a student at Grand Circus in Detroit, Michigan. I am currently ${age} years old and my birthday is on ${birthday}.`)
}
